...
import 'package:mycrew/models/job.dart'; 
          ...
          children: [
            ...
            Row(  
              children: [
                Icon(
                  job.isMark?
                   Icons.bookmark:Icons.bookmark_outline_rounded,
                  color: job.isMark?
...
Container(
  ...
  child: ElevatedButton(style: ElevatedButton.styleFrom(elevation: 0,
